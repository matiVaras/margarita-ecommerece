...
require_once "Clases/Marca.php";
    ...
    $prenda = (new Prenda())->get_por_id($productoSeleccionado);
    $numeroId = $catalogo->catalogo_por_prenda($productoSeleccionado);
...
<div class="container">
    <h1 class="text-center p-4"><?= $prenda->getNombre() ?></h1>
<div class="row">
